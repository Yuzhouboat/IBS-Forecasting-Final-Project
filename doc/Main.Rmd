...
&&&14 The Logic of this stategies
```{r, echo=FALSE}
...
pret  <-  252*(ReVol.va[,5]*weight  + 0.03/252 *(1-weight))
pretEquity   <-  252*(ReVol.va[,5]* 1)

# Volatility for portfolios (day to year)
...
print(cbind(mean(pret),sd(pret)))
print(cbind(mean(pretEquity),sd(pretEquity)))

# Sharpe ratios
print("Sharpe ratios (annualized)")
print( (mean(pret)-0.03)/sd(pret))
print( (mean(pretEquity)-0.03)/sd(pretEquity))       
```
